...
namespace KisiselBlog.Migrations
{
    ...
    [Migration("20250306131545_InitialCreate")]
            ...
            modelBuilder.Entity("KisiselBlog.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "frontend",
                            CreatedDate = new DateTime(2025, 1, 6, 16, 15, 45, 413, DateTimeKind.Local).AddTicks(8058),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "all",
                            CreatedDate = new DateTime(2025, 2, 6, 16, 15, 45, 413, DateTimeKind.Local).AddTicks(8074),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "web",
                            CreatedDate = new DateTime(2024, 12, 6, 16, 15, 45, 413, DateTimeKind.Local).AddTicks(8076),
